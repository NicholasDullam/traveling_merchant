    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', position: 'relative', height: '38px', marginTop: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
                <IoIosArrowBack style={{ opacity: props.page > 1 ? '1' : '.3', cursor: 'pointer' }} onClick={() => props.page > 1 ? props.handlePageChange(props.page - 1) : null }/>
                ...
                <IoIosArrowForward style={{ opacity: props.hasMore ? '1' : '.3', cursor: 'pointer' }} onClick={() => props.hasMore ? props.handlePageChange(props.page + 1) : null }/>
            </div>
